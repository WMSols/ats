class AppTexts {
  ...
  static const String requirementsCommaSeparated =
  ...
  static const String noDocumentsAvailable =
      "No documents available. Create documents first.";
  static const String noRequiredDocuments = "No required documents";
  static const String uploadRequiredDocuments =
      "Please upload all required documents in the Documents screen before applying for this job";
  static const String allDocumentsUploaded =
  ...
  static const String searchDocuments =
      "Search documents by title or description...";
  static const String noDocumentsFound =
  ...
  static const String deleteCandidateConfirmation =
      "Are you sure you want to delete";
  static const String deleteCandidateWarning =
      "This will permanently delete the candidate and all associated data including documents, applications, and profile. This action cannot be undone.";
  ...
  static const String manageAdminsToBeImplemented =
      "Manage Admins - To be implemented";
  ...
  static const String noAdminsFound =
      "No admins or recruiters found matching your search";
  static const String noAdminsAvailable = "No admins or recruiters available";
  static const String changeRole = "Change Role";
  static const String changeRoleConfirmation =
  ...
  static const String pdfViewerNotAvailable =
      "PDF viewer not available on this platform. Please use the browser to view.";
  static const String documentPreviewNotAvailable =
  ...
  static const String denyDocumentConfirmation =
      "Are you sure you want to deny this document? An email will be sent to the candidate.";
  static const String denialReason = "Denial Reason";
  static const String denialReasonHint =
      "Enter the reason for denial (optional)";
