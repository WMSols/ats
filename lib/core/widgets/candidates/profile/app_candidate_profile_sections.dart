...
class AppCandidateProfileSections {
  ...
  static List<DataRow> buildAllSections({
    ...
    rows.addAll(_buildStatisticsSection(context, documentsCount, applicationsCount));
    rows.addAll(_buildAgentAssignmentSection(
      context,
      profile,
      agentName,
      isSuperAdmin,
  ...
  static List<DataRow> _buildCandidateProfileSection(
    ...
    rows.add(AppCandidateProfileDataRow.buildDataRow(
      context,
  ...
  static List<DataRow> _buildWorkHistorySection(
    ...
    final rows = <DataRow>[];
    final workHistoryText = AppCandidateProfileFormatters.formatWorkHistory(profile);
  ...
  static List<DataRow> _buildEducationSection(
    ...
    final rows = <DataRow>[];
    final educationText = AppCandidateProfileFormatters.formatEducation(profile);
  ...
  static List<DataRow> _buildCertificationsSection(
    ...
    final rows = <DataRow>[];
    final certificationsText = AppCandidateProfileFormatters.formatCertifications(profile);
